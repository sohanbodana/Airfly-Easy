...
const PassengerData = () => {
    ...
    const handleSearch = async (e) => {
        e.preventDefault();
        try {
            const response = await Axios.post("http://localhost:3001/SearchPassengerUsingInput", {
        ...
        <div>
            ...
            <div>
                <form onSubmit={handleSearch}>
                    <div id="mydata" >
                        <center style={inlinecss}>
                            <h4 className="text-white">Easy Search -Flightdata</h4>
                            <table cellPadding="8" >
                                <tbody style={{ margin: '0px', color: 'white' }}>
                                    <tr>
                                        <td>Search</td>
                                        <td>
                                            <label className="tbtd">You can search using Name & PNR & EMAIL</label>
                                            <input
                                                type="text"
                                                placeholder="NAME/PNR/EMAIL/"
                                                className="Aa"
                                                name="origin"
