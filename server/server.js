...
// const password = encodeURIComponent("12243648@sS");

// ///////  new MONGODB 
// const uri = "mongodb+srv://sohanbodana27:password@cluster0.i1iz0ky.mongodb.net/?retryWrites=true&w=majority";
...
//     const database = client.db('airfly'); // Replace with your MongoDB database name
//     const flightCollection = database.collection('flightshow');
//     const signupCollection = database.collection('signup');
...
//     const { PNR,name, age, email, contact, FID, AIRLINE, DepartTime, ArrivalTime, Origin, Destination, fclass, gender, address, state } = req.body;
...
//     const { origin } = req.body;
//     // const origin = '1001';
//     const query = `SELECT PNR ,name,age,email,contact,FID,AIRLINE,DepartTime,ArrivalTime,Origin,Destination,FClass FROM TICKET WHERE PNR = ? OR name=? OR email=? OR contact=?;`;
